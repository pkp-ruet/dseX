  ...
  return (
    <>
      ...
      <div className="page-narrow space-y-10">
        <PageHeader
          eyebrow="Privacy · Last updated May 2025"
          title="Privacy Policy"
          bn="আপনার কোন তথ্য আমরা রাখি, কেন রাখি আর কীভাবে ব্যবহার করি — সহজ ভাষায়।"
          lead={<>This privacy policy explains how TopStockBD (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) collects and uses information when you visit <strong>topstockbd.com</strong>.</>}
        />
        ...
        <section className="space-y-3.5">
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-text-main">Cookies</h2>
          <p className="text-lg leading-[1.78] text-text-muted">
          ...
          <ul className="space-y-3">
            <li className="flex gap-3 text-lg leading-[1.7] text-text-muted">
              ...
              <span><strong className="text-text-main">Analytics:</strong> to understand which pages are visited and how users navigate the site</span>
            </li>
            <li className="flex gap-3 text-lg leading-[1.7] text-text-muted">
              <span aria-hidden="true" className="mt-[0.62em] h-[7px] w-[7px] shrink-0 rounded-full bg-primary" />
              <span><strong className="text-text-main">Advertising:</strong> to serve relevant advertisements through Google AdSense (see below)</span>
            </li>
          </ul>
          <p className="text-lg leading-[1.78] text-text-muted">
        ...
        <section className="space-y-4">
          ...
          <div className="soft-card p-5 space-y-3">
            <p className="text-base leading-[1.7] text-text-muted">
