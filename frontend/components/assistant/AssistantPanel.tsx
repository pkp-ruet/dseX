...
export default function AssistantPanel({
  ...
  return (
    ...
    >
      ...
      <div
        ref={panelRef}
        className="disha-rise relative z-[1] flex h-[82vh] w-full max-w-md flex-col overflow-hidden rounded-t-xl bg-surface shadow-lift sm:h-[620px] sm:rounded-xl"
      >
        <header className="flex items-center justify-between gap-2 border-b border-border px-3.5 py-2.5">
          <div className="flex items-center gap-2">
            <span
              aria-hidden
              className="inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold text-surface"
            ...
            <div className="leading-tight">
              ...
              <div className="text-xs text-text-muted">{PERSONA.tagline}</div>
            </div>
          </div>
          <button
            type="button"
