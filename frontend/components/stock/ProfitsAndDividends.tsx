          ...
          >
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={profitData} margin={{ top: 28, right: 8, left: 8, bottom: 0 }} barCategoryGap="30%">
                <CartesianGrid vertical={false} stroke="#1E3A5F" strokeOpacity={0.4} />
                ...
                <Bar dataKey="profit" radius={[6, 6, 0, 0]}>
                  ...
                  {profitData.map((d, i) => (
                    <Cell
                      key={i}
                      fill={(d.profit ?? 0) >= 0 ? "#34D399" : "#F87171"}
                    />
                  ))}
                </Bar>
              </BarChart>
            ...
            >
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={dividendData} margin={{ top: 28, right: 8, left: 8, bottom: 0 }} barCategoryGap="30%">
                  ...
                  />
                  <Bar dataKey="cash" fill="#34D399" radius={[6, 6, 0, 0]}>
                    <LabelList
                      dataKey="cash"
                      position="top"
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-0.5 sm:gap-3 mb-1">
        <p className="text-base font-bold" style={{ color: "#F1F5F9" }}>{title}</p>
        <p className="text-xs font-medium" style={{ color: "#CBD5E1" }}>{subtitle}</p>
      </div>
      {pill && (
        <p
      ...
      {caption && (
        <p className="text-sm mt-3 leading-snug" style={{ color: "#CBD5E1" }}>
          {caption}
        </p>
      )}
    </div>
