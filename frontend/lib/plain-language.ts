...
export interface HealthCheckRow {
  ...
  oneLine: string;
  learnMore: string;
  /** Same three lines in everyday Bengali (Western digits only). */
  headlineBn: string;
  oneLineBn: string;
  learnMoreBn: string;
}
...
const PILLAR_PHRASES: Record<string, [HealthCheckRow, HealthCheckRow, HealthCheckRow]> = {
  p1_biz: [
    { pillarKey: "p1_biz", status: "strong", headline: "Good Profit",
      ...
      headlineBn: "ভালো লাভ", oneLineBn: "প্রতি বছরই লাভ করে।",
      learnMoreBn: "কোম্পানিটি বছরের পর বছর ধারাবাহিকভাবে লাভ করেছে। ব্যবসা ভালো চলছে।" },
    { pillarKey: "p1_biz", status: "fair", headline: "Profit Goes Up and Down",
      ...
      headlineBn: "লাভ ওঠানামা করে", oneLineBn: "কোনো বছর ভালো, কোনো বছর না।",
      learnMoreBn: "লাভ বছর বছর অনেক বদলায়। বড় বিনিয়োগের আগে আগামী এক-দুই বছর কেমন করে দেখে নিন।" },
    { pillarKey: "p1_biz", status: "weak", headline: "Weak Profit",
      ...
      headlineBn: "দুর্বল লাভ", oneLineBn: "লোকসান করে, বা কোনোমতে টিকে আছে।",
      learnMoreBn: "কোম্পানিটি আয় করতে হিমশিম খাচ্ছে। এটা কেনা মানে ভালো দিন ফিরবে বলে আশা করা।" },
  ],
  p2_health: [
    { pillarKey: "p2_health", status: "strong", headline: "Strong Money Health",
      ...
      headlineBn: "মজবুত আর্থিক অবস্থা", oneLineBn: "ঋণ কম, হাতে নগদ যথেষ্ট।",
      learnMoreBn: "কোম্পানির ঋণ বেশি নয়, আর খারাপ সময়েও চলার মতো নগদ আয় করে।" },
    { pillarKey: "p2_health", status: "fair", headline: "Okay Money Health",
      ...
      headlineBn: "মোটামুটি আর্থিক অবস্থা", oneLineBn: "ঋণ আর নগদ ঠিকঠাক, খুব ভালো নয়।",
      learnMoreBn: "বিল মেটাতে পারে, কিন্তু ব্যবসা মন্দা গেলে বড় কোনো সঞ্চয় নেই।" },
    { pillarKey: "p2_health", status: "weak", headline: "Weak Money Health",
      ...
      headlineBn: "দুর্বল আর্থিক অবস্থা", oneLineBn: "ঋণ বেশি, বা নগদ খুব কম।",
      learnMoreBn: "ভারী ঋণ বা কম নগদ কোম্পানিকে নড়বড়ে করে দিতে পারে, বিশেষ করে বাজার পড়লে।" },
  ],
  p3_moat: [
    { pillarKey: "p3_moat", status: "strong", headline: "Strong Business",
      ...
      headlineBn: "শক্তিশালী ব্যবসা", oneLineBn: "নিজের খাতে মজবুত অবস্থান।",
      learnMoreBn: "প্রতিযোগীরা সহজে এর গ্রাহক নিতে পারে না। ভালো মুনাফার হার আর স্থির বিক্রি আসল শক্তির প্রমাণ।" },
    { pillarKey: "p3_moat", status: "fair", headline: "Average Business",
      ...
      headlineBn: "সাধারণ ব্যবসা", oneLineBn: "চলছে ঠিকঠাক, কিন্তু নেতা নয়।",
      learnMoreBn: "স্বাভাবিক প্রতিযোগিতার মুখে আছে। লাভ আর বিক্রি ঠিক আছে, বিশেষ কিছু নয়।" },
    { pillarKey: "p3_moat", status: "weak", headline: "Weak Business",
      ...
      headlineBn: "দুর্বল ব্যবসা", oneLineBn: "প্রতিযোগিতা অনেক, লাভ সামান্য।",
      learnMoreBn: "মুনাফার হার কম, বিক্রি অনিশ্চিত, প্রতিযোগী অনেক। খাতে সমস্যা হলে সহজেই ধাক্কা খায়।" },
  ],
  p4_val: [
    { pillarKey: "p4_val", status: "strong", headline: "Cheap Price Now",
      ...
      headlineBn: "এখন দাম সস্তা", oneLineBn: "আজ স্বাভাবিকের চেয়ে কম দামে মিলছে।",
      learnMoreBn: "বাজার এখন এই শেয়ারের জন্য আগের বছরগুলোর তুলনায় কম দাম চাইছে। ভালো কোম্পানি ছাড়ে কেনার সুযোগ হতে পারে।" },
    { pillarKey: "p4_val", status: "fair", headline: "Fair Price",
      ...
      headlineBn: "ন্যায্য দাম", oneLineBn: "দাম মোটামুটি স্বাভাবিক।",
      learnMoreBn: "সস্তাও নয়, দামিও নয়। নিজের স্বাভাবিক দামের কাছাকাছি।" },
    { pillarKey: "p4_val", status: "weak", headline: "Looks Costly",
      ...
      headlineBn: "দাম বেশি মনে হচ্ছে", oneLineBn: "আজ স্বাভাবিকের চেয়ে বেশি দামে।",
      learnMoreBn: "এখন আপনি স্বাভাবিকের চেয়ে বেশি দাম দিচ্ছেন। দ্রুত বাড়বে বলে খুব নিশ্চিত না হলে কম দামের জন্য অপেক্ষা করা ভালো।" },
  ],
  p5_div: [
    { pillarKey: "p5_div", status: "strong", headline: "Strong Dividend",
      ...
      headlineBn: "ভালো লভ্যাংশ", oneLineBn: "প্রতি বছর ভালো নগদ লভ্যাংশ দেয়।",
      learnMoreBn: "প্রতি বছর লাভ থেকে নগদ দেয়, আর অঙ্কটা বাড়ছে। নিয়মিত আয়ের জন্য ভালো।" },
    { pillarKey: "p5_div", status: "fair", headline: "Some Dividend",
      ...
      headlineBn: "কিছুটা লভ্যাংশ", oneLineBn: "কখনো নগদ দেয়, প্রতি বছর নয়।",
      learnMoreBn: "কখনো দেয়, কখনো বাদ যায়। কিছু নগদ পেতে পারেন, কিন্তু প্রতি বছর নিশ্চিত নয়।" },
    { pillarKey: "p5_div", status: "weak", headline: "Low Dividend",
      ...
      headlineBn: "কম লভ্যাংশ", oneLineBn: "শেয়ারহোল্ডারদের নগদ দেয় কমই।",
      learnMoreBn: "নগদ লভ্যাংশের ইতিহাস কম বা নেই। নিয়মিত আয় চাইলে এটা সঠিক শেয়ার নয়।" },
  ],
};
